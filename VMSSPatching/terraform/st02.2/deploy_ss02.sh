...
#vars
CLIENT_BUILD_DIR=~/VMssBatchPatch/ss02
...
wget -q https://raw.githubusercontent.com/sarcalier/azuretedeploy/dev/VMSSPatching/terraform/st02.2/main.tf -O main.tf
